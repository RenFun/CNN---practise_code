<<<<<<< HEAD
# Author: RenFun
# File: CNN_mnist_learningrate.py
# Time: 2022/01/05
...
# LR = 0.01                               # 学习率
Learningrate = [0.1, 0.01, 0.001]                       # 设置不同大小的学习率
...
for i in range(3):
    ...
    optimizer1 = torch.optim.SGD(cnn.parameters(), lr=Learningrate[i])
    # 损失函数选择交叉熵函数
...
plt.subplot(121)
plt.plot(np.arange(1, 21), train_loss[0: 20], color='lightblue', label='学习率0.1')
plt.plot(np.arange(1, 21), train_loss[20: 40], color='royalblue', label='学习率0.01')
plt.plot(np.arange(1, 21), train_loss[40: 60], color='orange', label='学习率0.001')
plt.xlabel("迭代次数")
plt.ylabel("训练损失值")
plt.xticks(np.arange(1, 21, 1))
plt.grid(b=True, linestyle='--')
plt.legend(loc='upper right')
# plt.savefig('CNN_mnist_learningrate.svg', bbox_inches='tight')
# plt.show()
plt.subplot(122)
plt.plot(np.arange(1, 21), accuracy[0: 20], color='lightblue', label='学习率0.1')
plt.plot(np.arange(1, 21), accuracy[20: 40], color='royalblue', label='学习率0.01')
plt.plot(np.arange(1, 21), accuracy[40: 60], color='orange', label='学习率0.001')
plt.xlabel("迭代次数")
plt.ylabel("精度")
plt.xticks(np.arange(1, 21, 1))
plt.grid(b=True, linestyle='--')
plt.legend(loc='upper left')
plt.savefig('CNN_mnist_learningrate_loss&accuracy.svg', bbox_inches='tight')
plt.show()
=======
# Author: RenFun
# File: CNN_mnist_learningrate.py
