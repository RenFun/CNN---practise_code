...
BATCH_SIZE = 100                         # 一批数据的规模，即一次训练选取的样本数量
LR = 0.2                                # 学习率
...
plt.plot(np.arange(1, 11), train_loss[0: 10], color='royalblue', label='卷积核3*3')
plt.plot(np.arange(1, 11), train_loss[10: 20], color='lightblue', label='卷积核5*5')
plt.plot(np.arange(1, 11), train_loss[20: 30], color='orange', label='卷积核7*7')
plt.xlabel("Epoch次数")
plt.ylabel("训练损失值")
