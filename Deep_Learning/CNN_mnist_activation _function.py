<<<<<<< HEAD
# Author: RenFun
# File: CNN_mnist_activation _function.py
# Time: 2022/01/05
...
# 设置一个列表，里面存放不同的激活函数的CNN模型，包含两个卷积层，卷积核大小为5，数量（通道数）为32，步长为1，选择填充；使用最大池化；一个全连接层
...
class CNN_ReLU(nn.Module):
    ...
    def forward(self, x):
        ...
        return output
# 将模型添加到列表中
CNN_activation_function.append(CNN_sigmoid())
CNN_activation_function.append(CNN_tanh())
CNN_activation_function.append(CNN_ReLU())
# 定义常量
